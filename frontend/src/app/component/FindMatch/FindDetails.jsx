                ...
                <div className="FindDetailsBtnSec">
                  ...
                  >
                    {friend ? (
                      <>
                        {" "}
                        <i className="bi bi-person-dash me-2 fs-4"></i> Unfriend{" "}
                      </>
                    ) : (
                      <>
                        {" "}
                        <i className="bi me-2 bi-person-add fs-4"></i>Friend
                      </>
                    )}
                  </button>
                  <button className="messagebtn m-3">
                    ...
                    <i className="bi bi-chat-left-dots text-light fs-5 ms-2"></i>
                  </button>
