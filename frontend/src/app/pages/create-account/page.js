...
export default function CreateAccount() {
  ...
  const validateStep = () => {
    switch (step) {
      ...
      case 4:
        return formData.mode.trim() !== ""; // ✅ Validate mode instead of dob
      case 5:
      ...
      case 11:
        return formData.profilePic.trim() !== "";
      case 12:
  ...
  const renderStep = () => {
    switch (step) {
      ...
      // Continue for other imported steps here...
      case 15:
        return (
          <div>
